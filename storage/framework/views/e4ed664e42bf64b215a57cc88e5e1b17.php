		...
		<div class="login-box">
			...
			<div class="card card-outline card-primary">
			  	...
			  	<div class="card-body">
					...
					<?php if(request()->has('reset') && request()->get('reset') === 'success'): ?>
...
unset($__errorArgs, $__bag); ?>
		  			...
		  			<p class="mb-1 mt-3">
				  		<a class="text-info" href="<?php echo e(route('admin.forgotPasswordForm')); ?>">لقد نسيت كلمة المرور الخاصة بي</a>
					</p>					
			  	</div>
			  	<!-- /.card-body -->
			</div>
		...
		<script>
			if (window.location.search.includes('reset=success')) {
				...
				window.history.replaceState({}, document.title, "<?php echo e(route('admin.login')); ?>");
			}
		</script>
		<!-- jQuery -->
...
</html><?php /**PATH C:\Users\A\Desktop\Shopo\Shopo\Shopo_api\resources\views/admin/login.blade.php ENDPATH**/ ?>